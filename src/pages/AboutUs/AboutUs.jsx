...
const AboutUs = () => {
    return (
        <div className="flex flex-col items-center px-6 py-1 md:py-2 lg:py-4">
            <div className="max-w-7xl w-full text-secondary-content rounded-2xl shadow-lg p-5 md:p-8 lg:p-12">
